/**
 * 📊 App Dashboard Page (/[locale]/(main)/app/dashboard/page.tsx)
 * 
 * Энэ нь App системийн dashboard хуудас юм.
 * Зорилго: App системийн статистик, хяналтын самбар
 * 
 * Features:
 ...
 * - 📱 Responsive grid
 * 
 * Current: Static template (same as Admin dashboard)
 * TODO: Implement App-specific statistics and metrics
 * 
