/**
 * 📊 Business Dashboard Page (/[locale]/(main)/business/dashboard/page.tsx)
 * 
 * Энэ нь Business системийн dashboard хуудас юм.
 * Зорилго: Business системийн статистик, хяналтын самбар
 * 
 * Current: Static template with mock data
 * TODO: Implement Business-specific metrics
 * 
